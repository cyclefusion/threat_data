...
The following are some numbers surrounding Animus activity to date. These stats were last updated on February 08, 2015. All activity 
is fully automated.
* Attacker IP addresses collected: 5943
* Total SSH attempts observed: 7459080
* Unique malware samples captured: 176
* Malicious domains identified: 48
* Unique passwords collected from sensors: 622863
* Unique usernames collected from sensors: 785

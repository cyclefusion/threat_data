...
The following are some numbers surrounding Animus activity to date. These stats were last updated on February 07, 2015. All activity 
is fully automated.
* Attacker IP addresses collected: 5917
* Total SSH attempts observed: 7427962
* Unique malware samples captured: 173
* Malicious domains identified: 48
* Unique passwords collected from sensors: 620867
* Unique usernames collected from sensors: 676

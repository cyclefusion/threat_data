...
is fully automated.
* Attacker IP addresses collected: 9196
* Total SSH attempts observed: 12312240
* Unique malware samples captured: 1363
* Malicious domains identified: 114
* Unique passwords collected from sensors: 736375
* Unique usernames collected from sensors: 10126
* SSH library versions observed from SSH bruteforce tools: 100
